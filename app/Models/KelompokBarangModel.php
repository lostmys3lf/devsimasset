...
class KelompokBarangModel extends Model
{
    ...
    public function getKelompokBarangBasedOnId($id){
        $db = db_connect();
    ...
    // input data
    public function create($id_kelompok_barang,$nama_kelompok_barang){
        $db = db_connect();
        ...
        $hasil = $db->query($sql, array($id_kelompok_barang, $nama_kelompok_barang));}
